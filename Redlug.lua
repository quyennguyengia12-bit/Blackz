--// =====================================================
--// CHUPPY HUB - CORE STANDALONE VERSION (NO WEB HUB DEPENDENCY)
...
-- ================= CONFIG / SETTINGS (BẬT/TẮT TRỰC TIẾP TẠI ĐÂY) =================
getgenv().ChuppySettings = {
	AutoFarm = true,         -- Bật/tắt Auto Farm
	MobAura = true,          -- Bật/tắt Gom quái (Bring Mobs)
	AutoSkill = true,        -- Bật/tắt Tự động dùng Skill (Z, X, C, V)
	AutoBuyHaki = false,     -- Bật/tắt Tự động mua Haki vũ trang
	AutoEnableHaki = true,   -- Bật/tắt Tự động bật Haki vũ trang
	AutoRandomFruit = false, -- Bật/tắt Tự động quay trái ác quỷ
	FarmDistance = 8,        -- Khoảng cách đứng so với quái
	TweenSpeed = 300         -- Tốc độ dịch chuyển
}
local S = getgenv().ChuppySettings
...
print("CHUPPY HUB CORE STANDALONE INITIALIZED SUCCESSFULLY!")
